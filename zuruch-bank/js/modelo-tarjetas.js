...
formulario.inputNumero.addEventListener('keyup', (e) => {
    ...
    if (valorInput[0] == 1) {
        ...
        imagen.src = 'img/logos/aireuropa.png';
        ...
        logoMarca.innerHTML = '';
        const imagen = document.createElement('img');
        imagen.src = 'img/logos/repsol.png';
        logoMarca.appendChild(imagen);
    } else if (valorInput[0] == 8) {
        logoMarca.innerHTML = '';
        const imagen = document.createElement('img');
        imagen.src = 'img/logos/zuruch.png';
        logoMarca.appendChild(imagen);
    }
...
document.getElementById("formulario-tarjeta").addEventListener("submit", function(event) {
    ...
    window.location.href = "tarjetas.html"; // Redirige a tarjetas.html
});